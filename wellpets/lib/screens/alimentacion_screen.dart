...
class _alimentacion_pageState extends State<alimentacion_page> {
  ...
  Color _buttonColor1 = const Color.fromARGB(255, 93, 182, 255); // Color inicial del botón 1

  double _buttonHeight2 = 60.0; // Altura inicial del botón 2
  Color _buttonColor2 = const Color.fromARGB(255, 93, 182, 255); // Color inicial del botón 2
  ...
  void _onButtonRelease1() {
    setState(() {
      ...
      _buttonColor1 = const Color.fromARGB(255, 93, 182, 255); // Revertir al color inicial
    });
  }
  ...
  void _onButtonRelease2() {
    setState(() {
      ...
      _buttonColor2 = const Color.fromARGB(255, 93, 182, 255); // Revertir al color inicial
    });
  }
