...
class _BlogScreenState extends State<ComunidadPage> {
  ...
  List<Map<String, String>> messages = [
    {
      'text':
          'Me parece muy importante lo de revisar a nuestros perros cada cierto tiempo',
      'user': 'Ana',
      'color': 'green'
    },
    {
      'text':
          'Deberían crear una nueva marca de comida para perros, están muy caras las de hoy',
      'user': 'Ruben',
      'color': 'red'
    },
    {
      'text':
          'Si quieren un buen shampoo para su cachorro deberían usar Thankful, lo recomiendo bastante :)',
      'user': 'Martin',
      'color': 'blue'
    },
  ];
